...
/*   Updated: 2023/09/05 20:41:39 by tde-los-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_string_put(s_m->mlx, s_m->win, 4, 242, 0xFFFFFF, "Extra Key");
	mlx_string_put(s_m->mlx, s_m->win, 4, 262, 0xFFFFFF, "M: Map");
	mlx_string_put(s_m->mlx, s_m->win, 4, 282, 0xFFFFFF, "ESC: Exit");
	mlx_string_put(s_m->mlx, s_m->win, 4, 302, 0xFFFFFF, "H: enable/disable option");
}
